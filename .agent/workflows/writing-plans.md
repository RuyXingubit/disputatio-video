...
1. Leia o arquivo [SKILL.md](file:///Users/ruy/Code/disputatio-video/.agent/skills/writing-plans/SKILL.md).
...
4. Informe o caminho onde o plano foi salvo (geralmente `.agent/skills/plans/YYYY-MM-DD-feature.md`).
